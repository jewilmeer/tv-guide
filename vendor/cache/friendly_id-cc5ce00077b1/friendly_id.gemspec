...
Gem::Specification.new do |s|
  ...
  s.files = [".gemtest", ".gitignore", ".travis.yml", ".yardopts", "Changelog.md", "Gemfile", "Guide.rdoc", "MIT-LICENSE", "README.md", "Rakefile", "WhatsNew.md", "bench.rb", "friendly_id.gemspec", "gemfiles/Gemfile.rails-4.0.rb", "lib/friendly_id.rb", "lib/friendly_id/.gitattributes", "lib/friendly_id/base.rb", "lib/friendly_id/candidates.rb", "lib/friendly_id/configuration.rb", "lib/friendly_id/history.rb", "lib/friendly_id/migration.rb", "lib/friendly_id/object_utils.rb", "lib/friendly_id/reserved.rb", "lib/friendly_id/scoped.rb", "lib/friendly_id/scopes.rb", "lib/friendly_id/simple_i18n.rb", "lib/friendly_id/slug.rb", "lib/friendly_id/slug_generator.rb", "lib/friendly_id/slugged.rb", "lib/friendly_id/version.rb", "lib/generators/friendly_id_generator.rb", "test/base_test.rb", "test/compatibility/ancestry/Gemfile", "test/compatibility/ancestry/ancestry_test.rb", "test/compatibility/threading/Gemfile", "test/compatibility/threading/Gemfile.lock", "test/compatibility/threading/threading.rb", "test/configuration_test.rb", "test/core_test.rb", "test/databases.yml", "test/generator_test.rb", "test/helper.rb", "test/history_test.rb", "test/object_utils_test.rb", "test/reserved_test.rb", "test/schema.rb", "test/scoped_test.rb", "test/shared.rb", "test/simple_i18n_test.rb", "test/slugged_test.rb", "test/sti_test.rb"]
